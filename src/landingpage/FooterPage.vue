<template>
    <section class="flex flex-col justify-center items-center px-6 py-12 max-w-6xl gap-25 mx-auto">
        ...
        <footer
            class="w-full  py-6 px-8 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
