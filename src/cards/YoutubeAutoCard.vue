  ...
  <div >
    <n-space vertical align="center" class="p-6 min-h-screen ">
      <n-alert type="info" :show-icon="true">
        <span class="font-bold">Automatic mode</span> tries your selected format and picks the best available if it's
        unavailable.
        <n-button size="tiny"  @click="active_learn_drawer = !active_learn_drawer">Learn</n-button>
      </n-alert>

      <n-drawer v-model:show="active_learn_drawer" :width="502" placement="bottom" mask-closable>
